package com.myflavor.myflavor.common.JWT;
...
public class JwtProvider {
  ...
  private Date getExpriationFromToken(String jws) throws Exception {
  ...
  private Claims getClaimFromToken(String jws) {
    Claims claims = null;
  ...
  private Header getHeaderFromToken(String jws){
    Header header = null;
