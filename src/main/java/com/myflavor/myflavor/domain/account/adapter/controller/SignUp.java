...
public class SignUp {
  ...
  @PostMapping ("/login")
  public void login(@RequestBody UserDTO.UserSignupRequest userDTO, HttpServletRequest request) {
  ...
  public ResponseEntity<?> socialLogin(@RequestParam String code, @PathVariable String socialDomain, HttpServletResponse response, HttpServletRequest request) throws Exception{
