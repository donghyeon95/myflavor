...
class Google implements SocialDomainStrategy {
	...
	public SocialUserServiceDTO login(String code, String socialDomain) throws Exception {
...
class Naver implements SocialDomainStrategy {
	...
	@Deprecated
	public SocialUserServiceDTO login(String code, String SocialDomain) {
		return new SocialUserServiceDTO();
	}
...
interface SocialDomainStrategy {
	...
	SocialUserServiceDTO login(String code, String SocialDomain) throws Exception;
