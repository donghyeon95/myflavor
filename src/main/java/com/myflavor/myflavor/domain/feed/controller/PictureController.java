...
import com.myflavor.myflavor.domain.feed.service.PictureService;
...
public class PictureController {
	...
	public ResponseEntity<Resource> getPicture(@PathVariable String userName,
		...
		try {
			...
			encodedFileName = Base64.getEncoder().encodeToString(resource.getFilename().getBytes(StandardCharsets.UTF_8));
